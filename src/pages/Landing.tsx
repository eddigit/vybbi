      ...
      <section className="pt-24 pb-16 px-2 sm:px-6">
        <div className="mx-auto max-w-[1800px] 2xl:max-w-[1920px] px-4">
          <div className="hidden xl:grid xl:grid-cols-[200px_minmax(0,1fr)_200px] gap-8 items-start">
            {/* Left Ad Slot */}
            <div className="xl:block sticky top-24 mb-24">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <Card className="group hover:shadow-glow transition-all duration-300 hover:-translate-y-2 bg-gradient-card border-border">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-lg font-bold mb-2 text-foreground">Programme parrainage</h3>
                <p className="text-sm text-muted-foreground mb-4">
                  Gagnez des commissions en recommandant Vybbi à votre réseau.
                </p>
                <Button variant="outline" size="sm" className="w-full" asChild>
                  <Link to="/parrainage">En savoir plus</Link>
                </Button>
              </CardContent>
            </Card>
          </div>

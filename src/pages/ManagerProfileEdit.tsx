  ...
  const fetchArtistRoster = async () => {
    try {
      ...
      if (data) {
        ...
        const artistIds = data.map(ma => ma.artist_profile_id);
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex gap-4">
            ...
            <Button variant="outline" onClick={() => navigate(`/managers/${id}`)}>
              Cancel
            </Button>
          </div>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            {artists.length === 0 && (
              <p className="text-muted-foreground">No artists under management yet.</p>
            )}
          </div>

-- CORRECTION DE LA MIGRATION - Version corrigée sans 'admin' profile_type
...
WITH CHECK (
  ...
  AND viewed_profile_id != viewer_profile_id
);
...
-- Durcir admin_mock_profiles - utiliser seulement app_role admin

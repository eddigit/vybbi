-- Temporarily remove foreign key constraints for test data
...
-- Insert sample agents and managers
INSERT INTO public.profiles (
  user_id, 
  display_name, 
  profile_type, 
...
(
  ...
  'Alex Martin',
  'manager',
  'Manager et booker pour événements privés et festivals. Expert en négociation de contrats et développement d''artistes.',
  'Marseille, France',
  'Spécialiste des festivals de musique depuis 7 ans. Réseau étendu dans toute l''Europe.'
);

-- Insert sample lieux (venues)
INSERT INTO public.profiles (
  user_id, 
  display_name, 
  profile_type, 

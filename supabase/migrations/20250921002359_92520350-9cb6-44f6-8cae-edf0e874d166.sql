-- Add direct audio URL to music_releases for web radio playback
ALTER TABLE public.music_releases ADD COLUMN IF NOT EXISTS direct_audio_url text;

-- Recreate get_radio_playlist to include direct_audio_url
DROP FUNCTION IF EXISTS public.get_radio_playlist();

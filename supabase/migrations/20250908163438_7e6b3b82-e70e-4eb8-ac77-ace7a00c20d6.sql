...
-- Update media_assets RLS policies to allow users to manage their own media
DROP POLICY IF EXISTS "Users can create media for their profiles" ON public.media_assets;
...
BEGIN
  ...
  VALUES (_user_id, _profile_type::app_role)

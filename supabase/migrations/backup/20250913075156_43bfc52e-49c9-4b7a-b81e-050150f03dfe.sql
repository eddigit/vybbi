...
-- Insert default templates with dark theme and correct logo
INSERT INTO public.email_templates (name, type, subject, html_content, variables) VALUES
(
  'Inscription utilisateur',
  'user_registration',
  'Bienvenue sur Vybbi - Votre inscription est confirmée !',
  '<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #0a0a0a; color: #e5e5e5;">
  <div style="max-width: 600px; margin: 0 auto; background-color: #171717; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.3);">
    <div style="background: linear-gradient(135deg, #8B5CF6, #3B82F6); padding: 40px; text-align: center;">
      <img src="https://fepxacqrrjvnvpgzwhyr.supabase.co/storage/v1/object/public/media/wolf-logo.png" alt="Vybbi Logo" style="width: 80px; height: 80px; margin-bottom: 20px; border-radius: 12px;">
...
(
  ...
  'admin_notification',
  'Nouvelle inscription sur Vybbi',
  '<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #0a0a0a; color: #e5e5e5;">
  <div style="max-width: 600px; margin: 0 auto; background-color: #171717; border-radius: 12px; overflow: hidden;">
    <div style="background: linear-gradient(135deg, #F59E0B, #DC2626); padding: 30px; text-align: center;">
      <img src="https://fepxacqrrjvnvpgzwhyr.supabase.co/storage/v1/object/public/media/wolf-logo.png" alt="Vybbi Logo" style="width: 60px; height: 60px; margin-bottom: 15px; border-radius: 8px;">
...
(
  'Notification d''avis',
  'review_notification',
  'Nouvel avis reçu sur votre profil Vybbi',
  '<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">

-- Create unique professional prospecting email templates
INSERT INTO public.email_templates (name, subject, html_content, type, variables) VALUES 
(
  'Premier Contact Professionnel Vybbi',
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, ''Segoe UI'', Roboto, sans-serif; background-color: hsl(222.2 84% 4.9%); color: hsl(210 40% 98%);">
  ...
  'vybbi_prospect_first_contact',
  '{"contact_name": "Nom du contact", "company_name": "Nom de l''entreprise", "prospect_type": "Type de prospect"}'
),
(
  'Relance Prospect Qualifié Vybbi',
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, ''Segoe UI'', Roboto, sans-serif; background-color: hsl(222.2 84% 4.9%); color: hsl(210 40% 98%);">
  ...
  'vybbi_prospect_followup',
  '{"contact_name": "Nom du contact", "company_name": "Nom de l''entreprise", "prospect_type": "Type de prospect"}'
),
(
  'Présentation Détaillée Vybbi Pro',

-- Create enum for roadmap item types
CREATE TYPE public.roadmap_item_type AS ENUM ('feature', 'task', 'selling_point');

-- Create enum for roadmap item status
CREATE TYPE public.roadmap_item_status AS ENUM ('done', 'in_progress', 'planned', 'on_hold', 'cancelled');

-- Create enum for roadmap item priority
CREATE TYPE public.roadmap_priority AS ENUM ('low', 'medium', 'high', 'critical');

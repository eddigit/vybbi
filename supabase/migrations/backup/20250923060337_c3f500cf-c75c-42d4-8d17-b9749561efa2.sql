-- Phase 1A: Core VYBBI Token Functions
-- Breaking down into smaller migrations to avoid deadlock

-- Function to award daily login tokens
...
-- Enhanced affiliate conversion with VYBBI rewards
...
BEGIN
  ...
  IF referrer_user_id IS NOT NULL THEN
    PERFORM public.award_vybbi_tokens(
      ...
      200,
      'referral_reward',
      format('Parrainage réussi ! Nouveau membre via votre lien (+200 VYBBI)'),
